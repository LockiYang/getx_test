...
class BasicRadio extends StatefulWidget {
  /// 标识当前Radio的Index
  ...
  @override
  BasicRadioState createState() => BasicRadioState();
}

class BasicRadioState extends State<BasicRadio> {
  ...
  @override
  void didUpdateWidget(BasicRadio oldWidget) {
