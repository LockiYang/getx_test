...
class MultiDataPicker extends StatefulWidget {
  ...
  @override
  _MultiDataPickerState createState() => _MultiDataPickerState();
...
class BrnDefaultMultiDataPickerDelegate implements MultiDataPickerDelegate {
  ///数据源
  List<MultiDataPickerEntity> data;
  ...
  BrnDefaultMultiDataPickerDelegate(
    ...
    if (data.isNotEmpty) {
      ...
      for (MultiDataPickerEntity brnPickerItem in data) {
        if (brnPickerItem.children.isNotEmpty) {
          _numberOfComponent = 2;

          for (MultiDataPickerEntity brnPickerItem1 in brnPickerItem.children) {
  ...
  int numberOfRowsInComponent(int component) {
    ...
    if (0 == component) {
      ...
      List<MultiDataPickerEntity> secondMap = data[firstSelectedIndex].children;
  ...
  String titleForRowInComponent(int component, int index) {
    if (0 == component) {
      ...
      MultiDataPickerEntity brnPickerItem = data[firstSelectedIndex];
      List<MultiDataPickerEntity> secondList = brnPickerItem.children;
      return secondList[index].text;
    } else {
      MultiDataPickerEntity brnPickerItem = data[firstSelectedIndex];
      List<MultiDataPickerEntity> secondList = brnPickerItem.children;
      List<MultiDataPickerEntity> threeList =
...
class MultiDataPickerEntity {
  ...
  /// 子项
  final List<MultiDataPickerEntity> children;

  MultiDataPickerEntity({
    required this.text,
    this.value,
    this.children = const [],
  });
