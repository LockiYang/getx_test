...
class ShanyanController extends GetxController {
  int code = 0;
  ...
  Future<void> initSDK() async {
    ...
    oneKeyLoginManager.init(appId: appId).then((shanYanResult) {
      code = shanYanResult.code ?? 0;
      result = shanYanResult.message ?? "";
      content.value = shanYanResult.toJson().toString();
  ...
  /// 3.拉起授权页
  Future<void> openLoginAuth() async {
...
//     shanYanUIConfig.ios.widgets = shanyanCustomWidgetIOS;
    ...
    /// 授权页导航栏
    shanYanUIConfig.androidPortrait.setAuthNavHidden = false;
    // shanYanUIConfig.androidPortrait.setFullScreen = true;
    shanYanUIConfig.androidPortrait.setNavColor = '#ffffff';
    shanYanUIConfig.androidPortrait.setAuthNavTransparent = false;
    shanYanUIConfig.androidPortrait.setNavTextBold = true;

    /// 授权页slogan
    shanYanUIConfig.androidPortrait.setSloganHidden = false;

    shanYanUIConfig.androidPortrait.setShanYanSloganHidden = false;
    ...
    shanYanUIConfig.androidPortrait.setCheckBoxOffsetXY = [0, 5];
...
//     buttonWidgetAndroid.backgroundColor = "#ffffff";
...
//     shanYanUIConfig.androidPortrait.widgets = shanyanCustomWidgetAndroid;
    ...
    oneKeyLoginManager
      ...
      Get.snackbar("Tips", "点击：${map.toString()}");
    });
